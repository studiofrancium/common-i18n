...
import ee.studiofrancium.common.i18n.CountryCode.US
import java.util.*
...
enum class CountryCode(
     ...
     * [CountryCode.UNDEFINED] returns `"UNDEFINED"`
    ...
    /**
     * [Eswatini](http://en.wikipedia.org/wiki/Eswatini)
     ...
     * [[XI](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#XI), XXI, -1,
     * User assigned]
     *
     * @since 1.28
     */
    ...
    companion object {
        private val alpha3Map: MutableMap<String?, CountryCode> = HashMap()
        private val alpha4Map: MutableMap<String?, CountryCode> = HashMap()
        private val numericMap: MutableMap<Int, CountryCode> = HashMap()

        /**
         * Get a `CountryCode` that corresponds to the given ISO 3166-1
         * [alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or
         * [alpha-3](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
         *
         *
         *
         ...
         *
         *
         * @param code An ISO 3166-1 [alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or [alpha-3](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
         * When `"UNDEFINED"` is given, [CountryCode.UNDEFINED][.UNDEFINED]
         * is returned.
         * In addition, for backward compatibility, some 4-letter [ISO 3166-3](https://en.wikipedia.org/wiki/ISO_3166-3) codes such
         * as `"ANHH"` are accepted.
         ...
         *
         *
         * @param code An ISO 3166-1 [alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) or [alpha-3](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code. Or `"UNDEFINED"` (case insensitive).
         * In addition, for backward compatibility, some 4-letter [ISO 3166-3](https://en.wikipedia.org/wiki/ISO_3166-3) codes such
         * as `"ANHH"` are accepted.
         * @return A `CountryCode` instance, or `null` if not found.
         * @see .getByCode
         * @since 1.13
         */
        fun getByCodeIgnoreCase(code: String?): CountryCode? {
         ...
         * `getByCode("jp", true)` returns `null`, but on the other hand,
         * `getByCode("jp", false)` returns [CountryCode.JP][.JP].
         * @return A `CountryCode` instance, or `null` if not found.
         */
        fun getByCode(code: String?, caseSensitive: Boolean): CountryCode? {
            val c = code ?: return null
            return when (c.length) {
                2 -> {
                    val c2 = canonicalize(c, caseSensitive)
                    getByAlpha2Code(c2)
                }
                3 -> {
                    val c2 = canonicalize(c, caseSensitive)
         ...
         * @return A `CountryCode` instance, or `null` if not found.
         * When [getCountry()][Locale.getCountry] method of the
         * given `Locale` instance returns `null` or an
         * empty string, [CountryCode.UNDEFINED][.UNDEFINED] is
         * returned.
         * @see Locale.getCountry
         */
        fun getByLocale(locale: Locale?): CountryCode? {
            if (locale == null) {
                return null
            }
         ...
         * @return If `code` is `null` or an empty string,
         * `null` is returned.
         * Otherwise, if `caseSensitive` is `true`,
         * `code` is returned as is.
         * Otherwise, `code.uppercase()` is returned.
         */
         ...
         *
         * @param code An ISO 3166-1 [alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2) code.
         * @return A `CountryCode` instance, or `null` if not found.
         * @since 1.23
         */
        fun getByAlpha2Code(code: String?): CountryCode? {
            return try {
                return code?.let { valueOf(it) }
         ...
         * [alpha-3](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
         *
         * @param code An ISO 3166-1 [alpha-3](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3) code.
         * @return A `CountryCode` instance, or `null` if not found.
         * @since 1.23
         */
        fun getByAlpha3Code(code: String?): CountryCode? {
            return alpha3Map[code]
        }
         ...
         * @since 1.23
         */
        fun getByAlpha4Code(code: String?): CountryCode? {
            return alpha4Map[code]
        }

        /**
         * Get a `CountryCode` that corresponds to the given
         * [ISO 3166-1
 * numeric](http://en.wikipedia.org/wiki/ISO_3166-1_numeric) code.
         *
         *
         *
         * Note that there are some pairs each of which shares the same numeric code.
         * The following table shows such pairs and which `CountryCode` instance
         ...
         * <br></br>
         *
         * @param code An [ISO 3166-1 numeric](http://en.wikipedia.org/wiki/ISO_3166-1_numeric) code.
         * @return A `CountryCode` instance, or `null` if not found.
         * If 0 or a negative value is given, `null` is returned.
         */
        fun getByCode(code: Int): CountryCode? {
            return if (code <= 0) {
                null
         ...
         * @return List of `CountryCode`. If nothing has matched,
         ...
         * @since 1.11
         */
        fun findByName(regex: String?): List<CountryCode> {
         ...
         *
         *
         * contains 6 `CountryCode`s as listed below.
         *
         *
         *
         ...
         * @since 1.11
         */
        fun findByName(pattern: Pattern?): List<CountryCode> {
            requireNotNull(pattern) { "pattern is null." }
            val list: MutableList<CountryCode> = ArrayList()
            for (entry in values()) {
                // If the name matches the given pattern.
                if (pattern.matcher(entry.alpha2).matches()) {
                    list.add(entry)
                }
            }
            return list
     ...
     * [CountryCode.CA][.CA] always returns [Locale.CANADA].
     *
     *
     *
     *
     ...
     * <tr>
     * <td>[CountryCode.CA]</td>
     * <td>[Locale.CANADA]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.CN]</td>
     * <td>[Locale.CHINA]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.DE]</td>
     * <td>[Locale.GERMANY]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.FR]</td>
     * <td>[Locale.FRANCE]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.GB]</td>
     * <td>[Locale.UK]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.IT]</td>
     * <td>[Locale.ITALY]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.JP]</td>
     * <td>[Locale.JAPAN]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.KR]</td>
     * <td>[Locale.KOREA]</td>
     </tr> *
     * <tr>
     * <td>[CountryCode.TW]</td>
     * <td>[Locale.TAIWAN]</td>
     </tr> *
     * <tr>
     ...
     *
     *
     * In addition, `toLocale()` of [ CountryCode.UNDEFINED][CountryCode.UNDEFINED] behaves a bit differently. It returns
     ...
     *
     *
     * @return A `Locale` instance that matches this `CountryCode`.
     */
     ...
     *
     *
     * This method is an alias of [Currency]`.`[ ][Currency.getInstance]`(`[ ][.toLocale]`)`. The only difference is that this method
     * returns `null` when `Currency.getInstance(Locale)`
     ...
     * this `CountryCode` instance does not have a currency.
     * [.AQ] (Antarctica) is one example.
     *
     *
     *
     *
     * In addition, this method returns `null` also when the ISO 3166
     * code represented by this `CountryCode` instance is not
     * supported by the implementation of [ ][Currency.getInstance]. At the time of this writing,
     * [.SS] (South Sudan) is one example.
     *
     *
     * @return A `Currency` instance. In some cases, null
     * is returned.
