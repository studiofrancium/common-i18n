...
/**
 * [ISO 15924<a> script code.
 *
 * @author Takahiko Kawasaki
 * @since 1.2
</a>](http://en.wikipedia.org/wiki/ISO_15924) */
enum class ScriptCode(
    ...
    companion object {
         ...
         */
        private val numericMap: MutableMap<Int, ScriptCode> = HashMap()
         ...
         * @return A `ScriptCode` instance, or `null` if not found.
         */
        fun getByCode(code: String?): ScriptCode? {
         ...
         * @since 1.13
         */
        fun getByCodeIgnoreCase(code: String?): ScriptCode? {
         ...
         * @param caseSensitive If `true`, the first letter of the given code should be
         * capital and the other letters should be small. If `false`,
         * whether letters are capital or small does not matter.
         * For example, `getByCode("JPAN", true)` returns
         * `null` but `getByCode("JPAN", false)` returns
         * [.Jpan].
         * @return A `ScriptCode` instance, or `null` if not found.
         */
        fun getByCode(code: String?, caseSensitive: Boolean): ScriptCode? {
         ...
         */
        fun getByCode(code: Int): ScriptCode? {
            return if (code <= 0) {
                null
         ...
         * @return List of `ScriptCode`. If nothing has matched,
         ...
         * @since 1.11
         */
        fun findByName(regex: String?): List<ScriptCode> {
         ...
         *
         *
         * contains 3 `ScriptCode`s as listed below.
         *
         *
         *
         *  1. [.Egyd] : Egyptian demotic
         *  1. [.Egyh] : Egyptian hieratic
         *  1. [.Egyp] : Egyptian hieroglyps
         *
         *
         ...
         * @since 1.11
         */
        fun findByName(pattern: Pattern?): List<ScriptCode> {
            requireNotNull(pattern) { "pattern is null." }
            val list: MutableList<ScriptCode> = ArrayList()
            for (entry in values()) {
